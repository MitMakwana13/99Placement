...
export const Route = createFileRoute("/assessment/$candidateId")({
  head: () => ({ meta: [{ title: "Assessment · 99Placement" }] }),
...
function AssessmentPage() {
  ...
  const handleNext = () => {
    if (current < questions.length - 1) {
      ...
      setSubmitted(true);
      // In a real app, we would mutation.mutate() to save scores to Supabase here
