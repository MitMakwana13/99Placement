...
export const Route = createFileRoute("/process-flow")({
  head: () => ({
    meta: [
      { title: "Process Flow · talentlab" },
      { name: "description", content: "10-step hiring process flow based on the PRD." },
    ],
  }),
  component: ProcessFlowPage,
});
